...
var App = function () {
  function App() {
    ...
    $('.j-submit-finish').on('click', function () {
      console.log('click finish');
      $('.j-contact input[name="submit"]').trigger('click');
    });
    $('.j-submit-back').on('click', function () {
  ...
  (0, _createClass3.default)(App, [{
    key: 'setHomeSlide',
    value: function setHomeSlide() {

      var $slideTotal = $('.j-home-hero-slide-total');
      var $slideCurrent = $('.j-home-hero-slide-current');
    ...
    value: function setGNav() {
      var $opener = $('.j-gnav-opener');
      var $closer = $('.j-gnav-closer');
      var $gnav = $('.j-gnav');
